...
RUN apt-get update -qq && apt-get install -qq -y wget fontconfig && \
	...
	wget --header="Authorization: Bearer ${GH_TOKEN}"  -q https://maven.pkg.github.com/Yumfriez/service-api/com/epam/reportportal/service-api/5.4.0/service-api-5.4.0-exec.jar
